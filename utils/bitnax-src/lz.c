...
/* C64 dechruncher sfx code (save/restore FA, clear (?) LDTND) */
static const char decruncher_c64[] = {
  
};

/* plus/4 dechruncher sfx code (save/restore FA, clear GRAPHM+CURBNK) */
static const char decruncher_plus4[] = {
  0x01, 0x10, 0x1b, 0x10, 0x00, 0x00, 0x9e, 0x34, 0x31, 0x32, 0x35, 0x3a,
  0x22, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x20, 0x42, 0x49, 0x54, 0x4e,
  0x41, 0x58, 0x20, 0x00, 0x00, 0x00, 0x78, 0x8d, 0x3f, 0xff, 0xa5, 0xae,
  0x48, 0xa2, 0x00, 0xbd, 0x4f, 0x10, 0x9d, 0x20, 0x00, 0xbd, 0x57, 0x10,
  0x9d, 0x28, 0x00, 0xe8, 0xd0, 0xf1, 0xa0, 0x01, 0xca, 0xbd, 0x2c, 0x08,
  0x9d, 0x00, 0xfc, 0x8a, 0xd0, 0xf6, 0xce, 0x3a, 0x10, 0xce, 0x3d, 0x10,
  0x88, 0xd0, 0xed, 0xa2, 0x1a, 0x4c, 0x20, 0x00, 0x38, 0x20, 0xef, 0x00,
  0x90, 0x3b, 0xf0, 0xf9, 0xa9, 0x00, 0x2a, 0x06, 0xee, 0xd0, 0x03, 0x20,
  0xef, 0x00, 0x90, 0x09, 0x06, 0xee, 0xd0, 0xf2, 0x20, 0xef, 0x00, 0xd0,
  0xed, 0x85, 0x4f, 0xa0, 0x00, 0xbd, 0x00, 0x00, 0xe8, 0xd0, 0x03, 0x20,
  ...
  
};
...
int crunch(lz_context* ctx) {
	...
	unsigned decruncher_size = ctx->plus4 ? sizeof decruncher_plus4 : sizeof decruncher_c64;
	...
	if(ctx->output_type == OUTPUT_SFX) {
		if(ctx->plus4) {
			// Output decruncher with loadadress 0x1001
			fwrite(decruncher_plus4, decruncher_size, 1, ctx->dst_file);
		} else {
			// Output decruncher with loadadress 0x0801
			fwrite(decruncher_c64, decruncher_size, 1, ctx->dst_file);
		}
	...
	if (ctx->output_type == OUTPUT_LEVEL || ctx->output_type == OUTPUT_BITFIRE) {
		...
		if (!ctx->plus4 && ((ctx->load_addr > 0xd000 && ctx->load_addr < 0xe000) || (ctx->load_addr + packed_size > 0xd000 && ctx->load_addr + packed_size < 0xe000))) {
		...
		packed_size -= 26;
		data_addr = decruncher_size + packed_size - 0xff + (ctx->plus4 ? 0x1000 : 0x0800) + 24;
		int offs_ = ctx->plus4 ? 0 : 0;			// C64 + plus/4 decruncher offsets equal (now)
		// Set up depacker values
		fseek(ctx->dst_file, 0x37 + offs_, SEEK_SET);	// +9
		fputc((packed_size >> 8) + 1, ctx->dst_file);

		fseek(ctx->dst_file, 0x3a + offs_, SEEK_SET);	// +9
		fputc(data_addr & 0xff, ctx->dst_file);
		fputc(data_addr >> 8, ctx->dst_file);

		unsigned mem_top = ctx->plus4 ? 0xfd00 : 0x10000;

		fseek(ctx->dst_file, 0x4c + offs_, SEEK_SET);	// +9
		fputc((mem_top - packed_size) & 0xff, ctx->dst_file);

		fseek(ctx->dst_file, 0x73 + offs_, SEEK_SET);	// +9
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);
		fseek(ctx->dst_file, 0xdc + offs_, SEEK_SET);	// +9
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);
		fseek(ctx->dst_file, 0x121 + offs_, SEEK_SET);	// +9
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);

		fseek(ctx->dst_file, 0x7b + offs_, SEEK_SET);	// +9
		fputc(ctx->output_begin & 0xff, ctx->dst_file);
		fputc(ctx->output_begin >> 8, ctx->dst_file);
...
main(int argc, char *argv[]) {
	...
	if(argc != 1) {
		fprintf (
			stderr,
			"\n=== Bitnax - compressor utility for Bitfire loader\n"
			"=== 230603: SFX patched version\n\n"
			"syntax: %s\n"
			...
			"\t[--plus4]                                    target system: plus/4 (default: C64)\n"
