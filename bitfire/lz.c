...
0x1c,0x08, //next line
0x00,0x00, //linenum
0x9e,0x32,0x30,0x37,0x38,//sys2078
0x3a,0x22,0x14,0x14,0x14,0x14,0x14,0x14,//:"<<<<<<
0x14,0x14,0x14,0x42,0x49,0x54,0x4e,0x41,0x58,//<<<BITNAX
0x00,0x00,0x00,
0x78, //sei
0xe6,0x01,//inc $01
0xa2,0x00,0xbd,0x46,0x08,//lda $0846,x
0x9d,0x20,0x00,0xe8,0xd0,0xf7,0xa0,0x01,0xca,
0xbd,0x2c,0x08,0x9d,0x00,0xff,//sta $ff00,x
0x8a,0xd0,0xf6,0xce,0x31,0x08,0xce,0x34,0x08,//dec $831; dec $834
0x88,
...
0xe6,0xf1,0xe6,0x43,0xe6,0xac,0x60,
0xc6,0x01,	//dex $01
0x58,		//cli
0x85,0x98,	//sta $98  ???
0x4c		//jmp ....
...
0x1b,0x10, //next line
0x00,0x00, //linenum
0x9e,0x34,0x31,0x32,0x35,//sys4125
0x3a,0x22,0x14,0x14,0x14,0x14,0x14,0x14,//:"<<<<<<
0x20,0x42,0x49,0x54,0x4e,0x41,0x58,0x20,//.BITNAX.
0x00,0x00,0x00,
0x78, //sei
0x8d,0x3f,0xff,//sta $ff3f
0xa2,0x00,
0xbd,0x46+6,0x10,//lda $1046+6,x
0x9d,0x20,0x00,//sta $0020,x
0xbd,0x46+6+3,0x10,//lda $1046+6+3,x
0x9d,0x20+3,0x00,//sta $0020+3,x
0xe8,//inx
0xd0,0xf7-6,//bne
0xa0,0x01,0xca,
0xbd,0x2c,0x08,//lda $....,x
0x9d,0x00,0xfc,//sta $fc00,x
0x8a,0xd0,0xf6,0xce,0x31+6,0x10,0xce,0x34+6,0x10,//dec $1031+6; dec $1034+6
0x88,
0xd0,0xed,0xa2,0x1a,0x4c,0x20,0x00,//jmp $0020
0x38,0x20,0xef,0x00,0x90,0x3b,0xf0,0xf9,0xa9,
0x00,0x2a,0x06,0xee,0xd0,0x03,0x20,0xef,0x00,0x90,0x09,0x06,0xee,0xd0,0xf2,0x20,
0xef,0x00,0xd0,0xed,0x85,0x4f,0xa0,0x00,0xbd,0x00,0x00,0xe8,0xd0,0x03,0x20,0xf9,
0x00,0x99,0x00,0x38,0xc8,0xc0,0x00,0xd0,0xef,0x98,0xd0,0x03,0x4c,0xe7,0x00,0x18,
0x65,0x4b,0x85,0x4b,0x90,0x02,0xe6,0x4c,0xa9,0x01,0x06,0xee,0xd0,0x03,0x20,0xef,
0x00,0xb0,0x17,0x06,0xee,0xd0,0x03,0x20,0xef,0x00,0x90,0x0c,0x06,0xee,0xd0,0x03,
0x20,0xef,0x00,0x2a,0x90,0xed,0xb0,0x7f,0x69,0x01,0x85,0xdd,0xa9,0x20,0x2a,0x06,
0xee,0xd0,0x03,0x20,0xef,0x00,0x2a,0x90,0xf6,0xa8,
0xb9,0x08+3,0x01,//lda $0108,y
0xf0,0x10,0x06,0xee,0xd0,0x07,0x84,0xa2,0x20,0xef,0x00,0xa0,0x00,0x2a,0x90,0xf2,
0x30,0x1f,0x85,0xc0,0xbd,0x00,0x00,0xe8,0xd0,0x03,0x20,0xf9,0x00,
0x79,0x10+3,0x01,//adc $0110+3,y
0xb0,0x03,0xc6,0xc0,0x38,0x65,0x4b,0x85,0xd8,0xa9,0x00,
0x79,0x18+3,0x01,//adc $0118+3,y
0x38,0xb0,0x09,
0x79,0x10+3,0x01,//adc $0110+3,y
0x65,0x4b,0x85,0xd8,0xa9,0xff,0x65,0x4c,0x85,0xd9,0xa0,0xff,0xc8,0xb9,0x00,0x10,
0x91,0x4b,0xc0,0xff,0xd0,0xf6,0x98,0x65,0x4b,0x85,0x4b,0x90,0x02,0xe6,0x4c,0x06,
0xee,0x4c,0x24,0x00,0x00,0xbc,0x00,0x00,0x84,0xee,0x26,0xee,0xe8,0xd0,0x06,0xe6,
0xf1,0xe6,0x43,0xe6,0xac,0x60,
0x8d,0x3e,0xff,	//sta $ff3e
0xa9,0x00,      //lda #0
0x85,0x83,      //sta $83
0x58,           //cli
0x4c            //jmp ...
...
int crunch(lz_context* ctx) {
	...
	if(ctx->output_type == OUTPUT_LEVEL || ctx->output_type == OUTPUT_BITFIRE) {
		...
		int offs_ = ctx->plus4 ? 6 : 0;
		// Set up depacker values
		fseek(ctx->dst_file, 0x2e + offs_, SEEK_SET);
		fputc((packed_size >> 8) + 1, ctx->dst_file);

		fseek(ctx->dst_file, 0x31 + offs_, SEEK_SET);
		fputc(data_addr & 0xff, ctx->dst_file);
		fputc(data_addr >> 8, ctx->dst_file);

		unsigned mem_top = ctx->plus4 ? 0xfd00 : 0x10000;

		fseek(ctx->dst_file, 0x43 + offs_, SEEK_SET);
		fputc((mem_top - packed_size) & 0xff, ctx->dst_file);

		fseek(ctx->dst_file, 0x6a + offs_, SEEK_SET);
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);
		fseek(ctx->dst_file, 0xd3 + offs_, SEEK_SET);
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);
		fseek(ctx->dst_file, 0x118 + offs_, SEEK_SET);
		fputc((mem_top - packed_size) >> 8, ctx->dst_file);

		fseek(ctx->dst_file, 0x72 + offs_, SEEK_SET);
		fputc(ctx->output_begin & 0xff, ctx->dst_file);
		fputc(ctx->output_begin >> 8, ctx->dst_file);
